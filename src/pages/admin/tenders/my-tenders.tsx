import { Close, Delete, FilterListRounded, Info } from "@mui/icons-material";
import {
  IconButton,
  MenuItem,
  Pagination,
...
const MyTenders = () => {
  ...
  const {
    ...
    `tenders/all-tender/by-memberId?userId=${
      user?.id
    }&page=${pageNumber}&limit=8${isOrderBy ? `&orderBy=${isOrderBy}` : ""}`
  );
