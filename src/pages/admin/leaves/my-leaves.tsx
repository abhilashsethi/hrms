				...
				{isLoading ? (
					...
					<>
						<section className="md:py-2 py-2">
							<div className="border border-dashed border-theme p-2 inline-block rounded-md mb-4">
								<PriorityHigh className="text-theme animate-bounce" />
								If You are applying{" "}
								<span className="font-semibold">Sick Leave</span> for next month
								then , 2 leave credits will be deduced from your credits .
							</div>
