...
import { CHATICON, MAIL, NEW_MAIL, NOTIFICATIONBELL } from "assets/home";
                  ...
                  <Link href={"/admin/email"}>
                    <Tooltip title="Mail">
                      <Badge
                        ...
                        color="warning"
                      >
                        <p className="cursor-pointer rounded-lg group bg-[#e7d0ff] hover:bg-white transition-all ease-in-out duration-200 p-2 shadow-md">
                          <img
