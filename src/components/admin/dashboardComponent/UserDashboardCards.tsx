...
import { DefaultDashboard, Leave } from "types";
...
const UserDashboardCards = () => {
	...
	const { data: dashboardData } = useFetch<DefaultDashboard>(
	...
	const cards = [
		{
			...
			name: "Total Email",
			count: dashboardData?.totalEmailCount || 0,
			link: "/admin/email",
		},
		{
			id: 2,
		...
		},
		{
			...
			count: dashboardData?.totalLeaveCount || 0,
