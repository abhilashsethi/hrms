            ...
            <div className="w-full flex flex-col !h-1/2 items-start justify-start gap-2">
              ...
              {item?.userId ? (
                <>
                  ...
                  <div className="absolute w-full h-40 translate-y-[100%] group-hover:translate-y-[0%] bottom-0 transition-all ease-in-out duration-300 bg-slate-700 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20 border-gray-100">
