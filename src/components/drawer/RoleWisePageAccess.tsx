...
const PageList = [
  ...
  { id: 100, value: "/admin/email/create", icon: <ICONS.Create />, name: "Create Email" },
  { id: 101, value: "/admin/email", icon: <ICONS.Inbox />, name: "Inbox" },
  { id: 102, value: "/admin/email/drafts", icon: <ICONS.Draft />, name: "Drafts" },
  { id: 103, value: "/admin/templates/create-template", icon: <ICONS.Create_Template />, name: "Create Email Templates" },
