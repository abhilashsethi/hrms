...
const UpcomingLeaves = () => {
  ...
  return (
    <section className="w-full p-6 rounded-lg bg-white shadow-xl mt-4">
      ...
      <div className="md:flex grid gap-2 mt-2">
        <div className="md:w-1/3 h-28 flex justify-center shadow-md items-center flex-col gap-3 rounded-lg bg-gradient-to-br from-emerald-400 to-emerald-200">
          <p className="text-lg font-semibold tracking-wide">12</p>
          <p className="text-sm font-semibold tracking-wide text-green-700">
            APPROVED
          </p>
        </div>
        <div className="md:w-1/3 h-28 flex justify-center shadow-md items-center flex-col gap-3 rounded-lg bg-gradient-to-br from-red-400 to-red-200">
          <p className="text-lg font-semibold tracking-wide">0</p>
          <p className="text-sm font-semibold tracking-wide text-red-700">
            REJECTED
          </p>
        </div>
        <div className="md:w-1/3 h-28 flex justify-center shadow-md items-center flex-col gap-3 rounded-lg bg-gradient-to-br from-yellow-400 to-yellow-200">
